async function fetchMessage(message, numberOfMessages) {
    ...
    if(!numberOfMessages) throw new ReferenceError('"numberOfMessages" Is Not Defined')
    if(typeof numberOfMessages !== "number") throw new SyntaxError('"numberOfMessages" Must Be Nubmer')
    if(numberOfMessages >= 100) throw new RangeError('"numberOfMessages" Can\'t Be More Than 100 For Now')
